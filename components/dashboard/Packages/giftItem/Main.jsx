...
const GiftMain = ({
	...
	const [inputList, setInputList] = useState([
		{ inputData: undefined, inputImage: undefined },
	]);
	const handleSingle = () => {
		setIsSingle(true);
		setIsMultiple(false);
              ...
              ${packageName === null && "text-black"} ${
               ...
               ${
							...
							{inputImageUndefined !== false && (
								<p className="text-sm my-2 text-center text-[#F30303] font-light mb-[-4px] sm:mb[-8px] ">
							...
							<div className="md:w-[45%] mt-8">
								<h2
									className={`${totalPrice == null && "text-black"} ${
										totalPrice == false && "text-[#F30303]"
									} font-14 sm:font-16 md:font-18`}
								>
									Total Price
								</h2>
								<div className="mt-2">
								...
								{totalPrice == false && totalPrice != null && (
									<p className="font-12 mt-1 text-[#F30303] font-light mb-[-4px] sm:mb[-8px] ">
										Required field
									</p>
								)}
