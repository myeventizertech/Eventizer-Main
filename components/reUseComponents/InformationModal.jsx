...
import {
	DatePickersStart,
	TimePickers,
} from "../each-profile/cinematography/orderRequest/DateTimeInputs";
...
const InformationModal = ({
    ...
    setselectedLocation(e.target.city.value)
		setFirstPage(false);
		setSecondPage(true);
	};
...
console.log(packageObj?.pricePerDay)
	let customerData = {
		packageObj: packageObj,
		vendor: vendor,
    price: packageObj?.pricePerDay * parseInt(peopleNumber),
		...
		<div>
			{modal && (
				<div
					className={`${
						modal && "shadow-lg"
					} my-5 container  md:w-[900px] w-[100%] bg-white rounded-md`}
				>
					<header className="h-[73px] w-[100%] ">
						<div className="flex justify-between ">
							<div className="flex items-center pt-5">
								...
								<h1 className="text-2xl font-normal ml-5">{service}</h1>
							</div>
							<div className="pt-5">
					...
					<div>
						...
						{firstPage && (
							<>
								<h2 className="text-xl font-medium text-center mt-12 mb-8">
									Fillup some information to book
								</h2>
								<Formik
								...
								>
									{(props) => (
										<Form
											onSubmit={handleOrderDataForPageOne}
											className="flex flex-col justify-center items-center w-320px  md:w-[454px] mx-auto"
										>
                              ...
                              props.setFieldValue(s,r)
											...
											<div
												className={` md:w-[492px]  w-[310px] font-14 sm:font-16 md:font-18 rounded-[8px] px-2 sm:px-[20px] h-[38px] sm:h-[45px] mb-5`}
											>
												<DatePickersStart
													name="startDate"
													startDate={startDate}
						...
						{secondPage && (
							<>
								<div className="mb-6">
									...
									<form
										onSubmit={handleOrderDataForPageTwo}
										className="flex flex-col items-center "
									>
										<div className="flex flex-col">
											<label
												role={"button"}
												className="my-2 label flex text-xl font-normal "
												htmlFor="ex1"
											>
												Wedding
												<input
													onChange={changeWedding}
													role={"button"}
						...
						{thirdPage && (
							<>
								<div>
									...
									<form
										onSubmit={handleOrderDataForPageThree}
										className="flex flex-col items-center "
									>
										<div className="flex flex-col">
											<label
												role={"button"}
												className="my-2 text-xl font-normal check flex"
												htmlFor="ex1"
											>
												Under 13
												<input
													onChange={checkUnder13}
													role={"button"}
													className=" border-gray-800"
													type="checkbox"
													id="ex1"
						...
						{fourthPage && (
							<>
								<div className="mb-6">
									<h2 className="text-xl font-medium text-center mt-12 mb-8">
										How many people want to take makeup service?
									</h2>
									<form
										onSubmit={handleOrderDataForPageFour}
										className="flex flex-col items-center "
									>
										<div className="flex flex-col">
											<label
