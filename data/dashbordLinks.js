...
let dashboardlinkVendor = [
  { name: "Profile", path: "/dashboard/profile", img: "/img/profile_icon.svg" },
  { name: "Order list", path: "/dashboard/order-list", img: "/img/order-list.svg" },
  { name: "My package", path: "/dashboard/my-package", img: "/img/package_icon.svg" },
  { name: "Withdraw", path: "/dashboard/withdraw", img: "/img/booking_icon.svg" },
];
